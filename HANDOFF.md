...
1. **Contact form backend: Formspree — done (2026-08-11).** `src/contact.njk` posts to `https://formspree.io/f/xdengeqk`, with a honeypot field (`_gotcha`) and `required` fields. Fully wired, no longer an open item.
