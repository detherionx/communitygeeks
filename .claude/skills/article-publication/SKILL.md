...
2. Confirm the article copy, original language, human author, date, confidence, topics, consent state, related pieces, and source links. Identify which language version is the human-authored source before editing either version. Never invent evidence or consent.
